...
export async function registerBus(busNumber,busCapacity,busType,source,routeId,destination,driverName,journeyDate,departureTime,arrivalTime,availableSeats,fare) {
  try {
    debugger;
    // post body
    const body = { busNumber,busCapacity,busType,source,destination,routeId,driverName,journeyDate,departureTime,arrivalTime,availableSeats,fare}
